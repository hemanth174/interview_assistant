...
// Configuration
// Change this to your deployed backend URL (e.g. "https://your-app.koyeb.app") when deploying
const BACKEND_URL = "https://hemanth789-bakend-interview-assistant.hf.space";
...
function handleAudioStream(response, onComplete, onEndedCallback) {
...
const startInterviewApiUrl = `${BACKEND_URL}/start-interview`;
...
async function startInterview() {
    ...
    try {
        ...
        const questionNumber = response.headers.get('X-Question-Number') || "1";
...
const submitAnswerApiUrl = `${BACKEND_URL}/submit-answer`;
...
const getFeedbackApiUrl = `${BACKEND_URL}/get-feedback`;
